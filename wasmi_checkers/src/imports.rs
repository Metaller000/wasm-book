...
impl<'a> ModuleImportResolver for RuntimeModuleImportResolver {
    fn resolve_func(&self, field_name: &str, _signature: &Signature)
        ...
        let func_ref = match field_name {
            "piecemoved" => FuncInstance::alloc_host(Signature::new(
                &[ValueType::I32, ValueType::I32, ValueType::I32, ValueType::I32, ValueType::I32][..], None),
                                                     PIECEMOVED_INDEX,
            ),
            "piececrowned" => FuncInstance::alloc_host(Signature::new(
                &[ValueType::I32, ValueType::I32][..], None),
                                                       PIECECROWNED_INDEX,
            ),
            _ => return Err(InterpreterError::Function(
