...
/*
    External functions provided by the runtime for the running WASM modile
*/
impl Runtime {
    pub fn new() -> Runtime {
        Runtime {}
    ...
    fn handle_piece_moved(&self, from: (i32, i32), to: (i32, i32))
        ...
        println!("A piece was moved from ({},{}) to ({},{})", from.0, from.1, to.0, to.1);
        Ok(None)
    }
...
/*
    Implement the External trait for our runtime, where it invokes the external functions we provide
    by function index from the WASM module
*/
